...
export const metadata: Metadata = {
  title: "Terms of Service — EternalNote",
  description: "The terms and conditions governing your use of EternalNote, your rights, and our responsibilities.",
}
      ...
      <article className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        ...
        <div className="flex flex-col gap-12">
          <Section title="Acceptance of Terms">
            <p>
              By accessing or using EternalNote, you agree to be bound by these Terms of Service. If you do not agree
              to these terms, please do not use our services. We reserve the right to modify these terms at any time,
              and continued use of EternalNote constitutes acceptance of any changes.
            </p>
          </Section>

          <Section title="Description of Service">
            <p>
              EternalNote provides a platform that allows users to create, store, and schedule the delivery of personal
          ...
          <Section title="Account Registration">
            <p>To use EternalNote, you must create an account. You agree to:</p>
          ...
          <Section title="User Content">
            <p>
              You retain full ownership of all content you create and upload to EternalNote. By using our service,
          ...
          <Section title="Delivery of Messages">
            <p>
              EternalNote will make every reasonable effort to deliver your messages to designated recipients
          ...
          <Section title="Payment and Subscriptions">
            <p>
              Certain features of EternalNote may require a paid subscription. Subscription fees are billed
          ...
          <Section title="Limitation of Liability">
            <p>
              To the fullest extent permitted by law, EternalNote and its team shall not be liable for any
          ...
          <Section title="Termination">
            <p>
              ...
              to EternalNote. Upon termination, your right to use the service will immediately cease.
          ...
          <Section title="Governing Law">
            <p>
              ...
              of the jurisdiction in which EternalNote operates, without regard to conflict of law
          ...
          <Section title="Contact Us">
            <p>
              ...
              <a href="mailto:legal@eternalnote.com" className="font-medium text-primary underline underline-offset-4 transition-colors hover:text-primary/80">
                legal@eternalnote.com
              </a>{" "}
              or visit our{" "}
