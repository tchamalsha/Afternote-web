...
export const metadata: Metadata = {
  title: "Privacy Policy — Afternote",
  description: "How Afternote collects, uses, and protects your personal information and the memories you entrust to us.",
}
      ...
      <article className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        ...
        <div className="flex flex-col gap-12">
          <Section title="Introduction">
            <p>
              At Afternote, your privacy is not just a policy — it is a promise. We understand that the memories,
            ...
            <p>
              By using Afternote, you agree to the collection and use of information in accordance with this policy.
          ...
          <Section title="Contact Us">
            <p>
              ...
              <a href="mailto:privacy@afternote.com" className="font-medium text-primary underline underline-offset-4 transition-colors hover:text-primary/80">
                privacy@afternote.com
              </a>{" "}
              or visit our{" "}
